          ...
          <div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
              <div class="col-first">
                  ...
                  <nav class="d-flex align-items-center">
                      ...
                      <a href="category.php">Vendors Category</a>
                  </nav>
              </div>
          </div>
      </div>
                  ...
                  <div class="row">
                      ...
                      <div class="col-lg-4 col-md-6">
                          <div class="single-product" style="margin:auto; padding-top: 20px; text-align: center; display:block;">
                              <img class="img-fluid" src="admin/p_img/<?php echo $row['v_img']; ?>" style="width:250px;height:250px;">
                              <div class="product-details" style="margin:auto; text-align: center; display:block;">
                                  <h6><strong><?php echo $row['v_name']; ?></strong></h6>

                                  <div class="price">
                                      <h6><strong>Campus: <?php echo $row['v_loct']; ?></strong></h6>
                                  </div>

                                    <div class="prd-bottom">
                                      <a href="catg.php?id=<?php echo $row['id'];?>" class="primary-btn">
                                          <p style="margin:auto; text-align: center; display:block;">View Available Product</p>
                                      </a>
                                  </div>
