    ...
    <div class="container">
        <div class="cart_inner">
            <div class="table-responsive">
                    ...
                    $use = $_SESSION['email'];
                     include 'connect.php';
                       $sql = "SELECT * FROM product_detail WHERE user ='$use' and status ='0'";
                      $query = mysqli_query($con, $sql);
                       ...
                       ?>
					    ...
					    $sql1 = "SELECT SUM(p_tota) AS value_sum FROM product_detail WHERE user= '$usemail' and status = '0'";
                        ...
                        if ($r = mysqli_num_rows($query) > 0) {
                            ...
                            <tr>
                                <td>
                                    <?php
                                    $usemail = $_SESSION['email'];
                                    $query2 = mysqli_query($con, "SELECT * FROM users WHERE email ='$usemail'");
                                    ...
                                    <div class="row" style="align-items: center; text-align: center;">
                                        ...
                                        &nbsp;
                                        <div>
                                            <input type="text" name="locate" value="<?php echo $row2['location']; ?>" class="form-control" readonly>
                                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="button-group-area mt-40">
                                        ...
                                        <button type="button" name="submit" onclick="payWithPaystack()"
                                            class="genric-btn primary circle arrow">Make Payment Now</button>
                                    </div>
                                </td>
                                <td>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <h4><strong>No Product Added to Cart</strong></h4>
                                </td>
                                <td>
...
// 	$query2 = mysqli_query($con, "UPDATE product_detail SET locate = '$locate', prod_id = '$prod_id' WHERE user = '$usemail'");
