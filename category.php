                  ...
                  <div class="row">
                      ...
                      $id = $_GET['cat'];
                          ...
                          <div class="col-lg-4 col-md-6">
                              <div class="single-product" style="margin:auto; padding-top: 30px; text-align: center; display:block;">
                          ...
                          <?php
                                        ...
                                        echo "<strong><i style='color: red; padding: 150px;'>Sorry".' '.$id.' '."Product(s) is Unavailable !!! 😐😐😐</i></strong>";
                                    }
