          ...
          <div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
              <div class="col-first">
                  ...
                  <nav class="d-flex align-items-center">
                      ...
                      <a href="category.php">Products Category</a>
                  </nav>
              </div>
          </div>
      </div>
                  ...
                  <ul class="main-categories">
                      <?php
                                    ...
                                    while($row = mysqli_fetch_array($query)){
                                        ?>
                      <li type="circle" class="main-nav-list"><a
                              href="category.php?cat=<?php echo $row['pro_cat']; ?>">
          ...
          <div class="col-xl-9 col-lg-8 col-md-7">
              ...
              <section class="lattest-product-area pb-40 category-list">
                  <div class="row">
                      <?php
                                    include 'connect.php';
                                    $sql = "SELECT * FROM products WHERE p_loct = 'MINI'";
                                    $query = mysqli_query($con, $sql);
                                    if ($r = mysqli_num_rows($query) > 0) {
                                    while($row = mysqli_fetch_array($query)){
                                        ?>
                      <div class="col-lg-4 col-md-6">
                          <div class="single-product" style="margin:auto; padding-top: 20px; text-align: center; display:block;">
                              <img class="img-fluid" src="admin/p_img/<?php echo $row['p_img']; ?>" style="width:250px;height:250px;">
                                  ...
                                  if ($row['p_tota'] == 0) {
                                    ...
                                    <div class="prd-bottom">
                                      <a href="product_detail.php?id=<?php echo $row['id'];?>" class="primary-btn">
                                          <p style="margin:auto; text-align: center; display:block;">View Product</p>
                                      </a>
                                  </div>
                                    <?php
                                  }
                      ...
                      <?php
                        ...
                        echo "<strong><i style='color: red; padding: 150px;'>Sorry No Available Products at MINI Campus Presently !!! 😐😐😐</i></strong>";
                    }
                    ?>
